...
- **List Tasks** — Display all tasks or filter them by status: todo, in-progress, done, or all (default).

# Project Structure

- **code.py** — Contains main code to run Taskey.
- **function.py** — Contains functions used in code.py.
